#ifndef SYSTEMVISUALNAVPOSELANDMARKS_H
#define SYSTEMVISUALNAVPOSELANDMARKS_H
 ...
 *
 */
class SystemVisualNavPoseLandmarks : public SystemVisualNav
{
public:
    explicit SystemVisualNavPoseLandmarks(const GaussianInfo<double> & density);
